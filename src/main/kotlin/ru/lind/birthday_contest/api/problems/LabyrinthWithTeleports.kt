...
import ru.lind.birthday_contest.problems.LabyrinthWithTeleportsProblem

fun Route.labyrinthWithTeleportsProblem(endpoint: String) = route(endpoint) {

    val problem = LabyrinthWithTeleportsProblem.init()
